...
Contents:
    FileFormat (foundry.InstanceFactory): contains data needed for a Clerk-
...
from ..builders import foundry
from ..builders import mapping
from ..inspectors import report
from . import lazy
 
      
@dataclasses.dataclass
class FileFormat(foundry.InstanceFactory):
    ...
    Args:
        ...
        instances (ClassVar[mapping.Catalog]): project catalog of instances.
